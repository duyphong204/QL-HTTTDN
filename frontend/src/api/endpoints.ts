...
export const endpoints = {
  ...
  employees: {
    root: "/employees/hr",
    byId: (id: string) => `/employees/hr/${id}`,
    me: "/employees/me",
    hrReport: "/employees/hr/statistics/hr-report",
    jobHistory: (id: string) => `/employees/hr/${id}/job-history`,
    changePosition: (id: string) => `/employees/hr/${id}/position`,
    updateProfile: (id: string) => `/employees/hr/${id}/profile`,
  },
  leaveRequests: {
    root: "/leave-requests",
