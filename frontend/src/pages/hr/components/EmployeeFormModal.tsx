      ...
      <div className="p-6 space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {!editingEmployee && (
            <>
              <div>
                ...
                <input required name="email" type="email" value={form.email} onChange={handleChange} className={inputClass} placeholder="example@company.com" />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-700">Mật khẩu <span className="text-red-500">*</span></label>
                <input required name="password" type="password" value={form.password} onChange={handleChange} className={inputClass} placeholder="••••••••" />
              </div>
            </>
          )}
          ...
          <div>
            ...
            <input required name="fullName" value={form.fullName} onChange={handleChange} disabled={!!editingEmployee} className={editingEmployee ? disabledClass : inputClass} />
          </div>
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <button type="submit" className="px-6 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 shadow-sm transition-all">
